...
model_name = f'rtdetr_dtx_hsdm_{date_str}_{str(model_version).zfill(2)}'
...
train_annotation_file_name = f'objectdata_240921_clean_ide_dset.parquet'
...
# Checkpoint
checkpoint_model_name = 'rtdetr_dtx_251012_08'
checkpoint = 'checkpoint-19600'
...
processor = RTDetrImageProcessor.\
    from_pretrained(training_checkpoint, **processor_params)
